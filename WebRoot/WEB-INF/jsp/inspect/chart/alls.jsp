...
<table style="width: 100%">
	<tr style="width: 100%;height: 50px">
		<td colspan="4" style="color:#FFF;font-size: 24px;line-height: 50px;text-align: left;">${data.info }</td>
	</tr>
	<tr style="width: 100%;height: 50px">
		<td width="25%" style="color:#FFF;font-size: 36px;line-height: 50px;">${data.title }</td>
		<td width="50%">
			<c:if test="${data.frontPage < data.currentPage }">
				<a class="w3-btn w3-round-xxlarge" href="<%=basePath%>/vipInspectData/charts/${data.cardCode }/${data.inspectCode }/${data.code }/${data.frontPage }.html">Previous</a> 
			</c:if>
			<c:if test="${data.nextPage > data.currentPage }">
				<a class="w3-btn w3-round-xxlarge" href="<%=basePath%>/vipInspectData/charts/${data.cardCode }/${data.inspectCode }/${data.code }/${data.nextPage }.html">Next</a>
			</c:if>
		</td>
		<td width="25%"></td>
	</tr>
        ...
        plotOptions: { 
	        ...
	        series: {
				...
				dataLabels: {
                    ...
                    formatter:function() { return this.y+ '${data.serie1Unit}'+'${data.unit}'; }
                }
            }
        },
        series: [
